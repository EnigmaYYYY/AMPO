...
injection_strategy='adaptive' # always or adaptive
...
off_policy_reward_manager='prob' #prob/random/naive
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.adaptive_mix_src.main_mix_dapo \
    ...
    data.length_strategy=${length_strategy} \
